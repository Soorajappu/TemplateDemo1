      ...
      <div>
          ...
          <div className='w-full h-screen flex overflow-hidden absolute items-center justify-center'>
              <div className='w-[340px] p-2 rounded-lg bg-[#325ef1]'>
                  <div className='p-2 bg-[#f1f1f1] rounded-lg'>
                  {step === 1 && (
                      <form onSubmit={handlePhoneSubmit}>
                      <h1 className='text-3xl text-center mb-4'>Forgot Password</h1>
                      <div className='mt-6'>
                          <label htmlFor='phone' className='text-lg block'>Phone Number</label>
                          <input 
                          id='phone' 
                          type='text' 
                      ...
                      <p className="text-sm text-black dark:text-gray-400 mt-2">
                        Sent OTP using email? <Link to={"/EmailOTP"} className="font-medium text-primary-600 hover:underline text-blue-500 hover:text-blue-800">OTP Using Email</Link>
                      </p>
